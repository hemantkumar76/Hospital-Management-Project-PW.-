...
public class medical implements med {
    ...
    public void update() {
        System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
        System.out.println("");
        System.out.println(" . . . Update Medical Stock   . . . ");
        System.out.println(" ");
        System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
        ...
        System.out.println("2. Number of box");
        System.out.println("3. Per Pack price ");
        ...
        if (option12 == 1) {
            ...
            System.out.println("ENter per pack price ");
            Scanner scan8 = new Scanner(System.in);
            String perPack = scan8.next();
            mediacalR.setMedicePerPack(perPack);
            medicalRecordDetails[medicalRecordCount][3] = mediacalR.getMedicePerPack();
    ...
    public void delete() {
        System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$*******");
        System.out.println("");
        System.out.println("Are you sure want to delete the information  ?");
        System.out.println("");
        System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$*******");
        System.out.println("");
        ...
        if (option13 == 1) {
            ...
            System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
            System.out.println("");
            System.out.println("1. Go back to  Medical Record Management");
